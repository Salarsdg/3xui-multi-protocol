...
apt install git
git clone https://github.com/Salarsdg/3xui-multi-protocol.git
...
git clone https://github.com/Salarsdg/3xui-multi-protocol.git
  ...
  wget https://raw.githubusercontent.com/Salarsdg/3xui-multi-protocol/master/3xui-multi-protocol.service
   cp /opt/freedom/x-ui/db/x-ui.db /opt/freedom/x-ui/db/backup.db
